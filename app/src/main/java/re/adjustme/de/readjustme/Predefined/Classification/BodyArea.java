...
public enum BodyArea {
    ...
    SPINE("Brustwirbelsäule", BwsPosture.values(), 600000L, new Sensor[]{ Sensor.SENSOR_FRONT, Sensor.SENSOR_LEFT_SHOULDER, Sensor.SENSOR_RIGHT_SHOULDER, Sensor.SENSOR_UPPER_BACK,Sensor.SENSOR_LOWER_BACK}),
    ...
    LWS("Lendenwirbelsäule", LwsPosture.values(), 6000000L, new Sensor[]{ Sensor.SENSOR_UPPER_BACK, Sensor.SENSOR_FRONT, Sensor.SENSOR_LEFT_SHOULDER, Sensor.SENSOR_RIGHT_SHOULDER,Sensor.SENSOR_LOWER_BACK});
